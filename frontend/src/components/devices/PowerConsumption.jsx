...
const PowerConsumption = ({ devices }) => {
  ...
  return (
    <div className="bg-linear-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg text-white p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="text-center">
          ...
          <div className="text-blue-100 text-sm">Total Power</div>
        </div>
        
        <div className="text-center">
          <div className="text-2xl font-bold">{stats.activeDevices}</div>
          <div className="text-blue-100 text-sm">Active Devices</div>
        </div>
        
        <div className="text-center">
          <div className="text-2xl font-bold">{formatCost(stats.dailyCost)}</div>
          <div className="text-blue-100 text-sm">Daily Cost</div>
        </div>
